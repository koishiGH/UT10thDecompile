...
postHeartStep = function()
{
    ...
    if (type != 1)
    {
        ...
        do
        {
            ...
            var currHspeed = hspd * sign(hspeed);
            
            while (collision_rectangle(xx + currHspeed, yy, xx2 + currHspeed, yy2, obj_heart, 0, 1))
            {
