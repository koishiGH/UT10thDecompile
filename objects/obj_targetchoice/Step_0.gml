...
if (image_speed == 0)
{
    if (control_check_pressed(0))
    {
        ...
        if (mons.object_index == obj_doghole_abberant)
        {
            x_offset = -80;
            y_offset = -30;
        }
        
        if (mons.object_index == obj_doghole_mrsunshine)
            y_offset = 40;
        
        instance_create(((mons.x + (wd / 2)) - 5) + x_offset, (mons.y - 5) + y_offset, obj_slice);
